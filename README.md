...
```javascript
import bifurcateByAsync from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-bifurcate-by@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-bifurcate-by@v0.2.1-esm/index.mjs';
```
